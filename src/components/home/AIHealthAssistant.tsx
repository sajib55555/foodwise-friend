...
const AIHealthAssistant = () => {
  ...
  return (
    ...
    >
      <CardHeader className="flex flex-row items-center justify-between pb-2 bg-gradient-to-r from-purple-100/40 to-transparent dark:from-purple-900 dark:to-purple-950/20">
