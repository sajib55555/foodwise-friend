...
const TodaysFoodConsumption: React.FC = () => {
        ...
        {isLoading ? (
          ...
          <div className="space-y-3">
            {meals.map((meal, index) => (
              <div key={index} className="p-2.5 bg-green-50/50 dark:bg-green-900/20 rounded-lg border border-green-100 dark:border-green-800/30">
                ...
                <div className="grid grid-cols-3 gap-2 mt-1 text-xs text-green-600 dark:text-green-400">
            ...
            <div className="mt-3 p-2.5 bg-green-100/50 dark:bg-green-900/30 rounded-lg border border-green-200 dark:border-green-800/50">
              ...
              <div className="grid grid-cols-3 gap-2 mt-1 text-xs text-green-700 dark:text-green-300">
          ...
          <div className="text-center py-4 text-muted-foreground text-sm">
            ...
            <p className="text-xs mt-1">Log your meals to see nutrition analysis</p>
          </div>
        )}
      </CardContent>
    </Card>
...
export default TodaysFoodConsumption;
