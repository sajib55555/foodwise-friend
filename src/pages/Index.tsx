...
const Index = () => {
  ...
  return (
    <PageTransition>
      ...
      <main className="flex-1 container max-w-4xl mx-auto px-4 pb-24 pt-2 relative overflow-y-auto">
        ...
        >
          ...
          >
            <h1 className="text-2xl md:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-500 via-indigo-600 to-blue-600">
              NutriTrack
            </h1>
          ...
          >
            <Button
              ...
              className="gap-2 shadow-md text-xs md:text-sm"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <motion.div 
              variants={itemVariants} 
              className={`rounded-2xl p-4 md:p-6 ${featureCardGradient} ${featureCardBorder}`}
            >
              <WaterTracker />
            </motion.div>
            <motion.div 
          ...
          >
            <div className="bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-500 p-4 md:p-6 relative overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row justify-between items-center relative z-10">
                <div className="text-white mb-4 md:mb-0">
                  <h3 className="text-base md:text-xl font-bold flex items-center">
                    <Sparkles className="mr-2 h-4 w-4 md:h-5 md:w-5" /> Unlock Premium Features
                  </h3>
                  <p className="text-white/80 text-xs md:text-sm max-w-md mt-2">
